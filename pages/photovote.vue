        ...
        <div class="card-body" v-if="photo.id == id">
            <div class="d-flex justify-content-center mt-5">
                <div class="card d-flex flex-column justify-content-center" style="width: 30rem;">
                    <img class="card-img-top" :src="getPhotoURL(photo.Photo)" alt="Card image cap">
                    <div class="effet"></div>
...
export default {
    ...
    methods: {
        ...
        async updateVote() {
            try {
                const response = await axios.put(`https://studiophotov2-d849983bf69e.herokuapp.com/photo/${this.id}/vote`);
        ...
        updateData() {
            this.updateVote();
            axios.post("https://studiophotov2-d849983bf69e.herokuapp.com/votant", {
                Nom: this.Nom,
                Prenom: this.Prenom,
                Email: this.Email,
